<div align="center">
  <img src="assets/app-icon-light-v2.png" width="112" alt="기특해 곰 얼굴 앱 아이콘" />
  <h1>기특해: 칭찬일기</h1>
...
- 해금된 동물의 랜덤 등장과 첫인사
- 동물별 말투를 적용한 AI 칭찬
- 해금된 동물들이 한 줄의 행동을 표현하는 선택형 파스텔 그림
- AI 오류·시간 초과 시 로컬 코멘트 자동 대체
- 칭찬 달력과 기록 상세 팝업
- 기록 수에 따라 빈자리가 채워지는 가족사진
- 개별 기록 삭제와 전체 초기화
- 개발 환경 전용 날짜 이동 도구
- 일기 원문을 포함하지 않는 앱인토스 사용 이벤트 분석
- 사용자별 AI 그림 하루 1회 제한
