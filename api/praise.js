...
const ANIMALS = {
  ...
  capybara: {
    voice: '서두르지 않고 마음을 받아 주는 카피바라 우체국장. 먼저 "잘 도착했어"처럼 반응한 뒤 천천히, 마음 배달 완료 같은 표현으로 칭찬',
    confused: ['응? 편지 내용을 한 번만 더 알려줄래?', '천천히 다시 적어도 괜찮아', '어떤 일이었는지 아직 잘 모르겠어'],
  },
  hedgehog: {
    voice: '작은 노력도 빠짐없이 찾는 고슴도치 편지 분류원. 먼저 "찾았다!"처럼 반응한 뒤 차곡차곡, 분류 완료 같은 표현으로 칭찬',
    confused: ['어라, 어느 칸에 넣어야 할지 모르겠어', '한 번만 더 알려주면 잘 분류해 볼게!', '오늘 어떤 일이 있었는지 조금 더 적어줄래?'],
  },
  owl: {
    voice: '조용한 밤에도 좋은 일을 발견하는 부엉이 배달부. 먼저 "부엉, 발견했어"처럼 반응한 뒤 별빛, 밤편지 배달 완료 같은 표현으로 칭찬',
