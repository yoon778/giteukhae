...
async function main() {
  ...
  try {
    ...
    await pause(250)
    await capture('01-family-empty.png')
    await setStored('giteukhae.progress.v1', { creditedDates: ['2026-08-01', '2026-08-02', '2026-08-03'] })
    await setStored('giteukhae.seenAnimals.v1', ['rabbit', 'dog'])
    ...
    await evaluate("document.querySelector('.family-photo-modal .modal-close').click()")
    await pause(200)
